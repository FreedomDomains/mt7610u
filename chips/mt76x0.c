...
u8 MT76x0_EeBuffer[EEPROM_SIZE] = {
	...
	INOUT PULONG pTxPwr)
{
	...
	memcpy(pTxPwr, (u8 *)&CfgOfTxPwrCtrlOverMAC, sizeof(CfgOfTxPwrCtrlOverMAC));
	DBGPRINT(RT_DEBUG_INFO, ("<--MT76x0_AsicGetTxPowerOffset\n"));
}
...
{
	CH_POWER *ch, *ch_temp;
	u8 base_pwr = pAd->DefaultTargetPwr;
	int i;
