...
typedef union _PBF_SYS_CTRL_STRUC {
	struct {
		u32 rsv5:7; /* Reserved */
		u32 CSR_TEST_EN:1;
		u32 MAC_CLKSEL:2; /* MAC clock selection */
		u32 PWRSV_EN:2;
		u32 SHRM_SEL:1; /* Shared memory access selection */
		u32 PBF_MSEL:2; /* Packet buffer memory access selection */
		u32 rsv4:5;
		u32 PBF_CLK_EN:1; /* PBF clock enable */
		u32 MAC_CLK_EN:1; /* MAC clock enable */
		u32 rsv3:6;
		u32 PBF_RESET:1; /* PBF hardware reset */
		u32 MAC_RESET:1; /* MAC hardware reset */
		u32 rsv:2;
	} field;
	u32 word;
} PBF_SYS_CTRL_STRUC;
