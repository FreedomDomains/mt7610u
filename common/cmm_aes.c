	...
	IN INT input)
{
	...
	/*u8 A2[6] =  {0x50, 0x30, 0xf1, 0x84, 0x44, 0x08};*/
	/*u8 A3[6] =  {0xab, 0xae, 0xa5, 0xb8, 0xfc, 0xba};*/
	u8 TK[16] = {0xc9, 0x7c, 0x1f, 0x67, 0xce, 0x37, 0x11, 0x85,
				  	0x51, 0x4a, 0x8a, 0x19, 0xf2, 0xbd, 0xd5, 0x2f};
	u8 PN[6] =  {0x0C, 0xE7, 0x76, 0x97, 0x03, 0xB5};
	u8 HDR[24]= {0x08, 0x48, 0xc3, 0x2c, 0x0f, 0xd2, 0xe1, 0x28,
					0xa5, 0x7c, 0x50, 0x30, 0xf1, 0x84, 0x44, 0x08,
					0xab, 0xae, 0xa5, 0xb8, 0xfc, 0xba, 0x80, 0x33};
	u8 AAD[22] = {0x08, 0x40, 0x0f, 0xd2, 0xe1, 0x28, 0xa5, 0x7c,
				     0x50, 0x30, 0xf1, 0x84, 0x44, 0x08, 0xab, 0xae,
				     0xa5, 0xb8, 0xfc, 0xba, 0x00, 0x00};
	u8 CCMP_HDR[8] = {0x0c, 0xe7, 0x00, 0x20, 0x76, 0x97, 0x03, 0xb5};
	u8 CCM_NONCE[13] = {0x00, 0x50, 0x30, 0xf1, 0x84, 0x44, 0x08, 0xb5,
						   0x03, 0x97, 0x76, 0xe7, 0x0c};
	u8 P_TEXT_DATA[20] = {0xf8, 0xba, 0x1a, 0x55, 0xd0, 0x2f, 0x85, 0xae,
						     0x96, 0x7b, 0xb6, 0x2f, 0xb6, 0xcd, 0xa8, 0xeb,
						     0x7e, 0x78, 0xa0, 0x50};
	u8 C_TEXT_DATA[28] = {0xf3, 0xd0, 0xa2, 0xfe, 0x9a, 0x3d, 0xbf, 0x23,
	...
	if (memcmp(res_buf, CCMP_HDR, 8) == 0)
					...
					res_buf, &res_len) == 0)
	{
		if (res_len == sizeof(C_TEXT_DATA) &&
				memcmp(res_buf, C_TEXT_DATA, res_len) == 0)
					...
					res_buf, &res_len) == 0)
	{
		if (res_len == sizeof(P_TEXT_DATA) &&
				memcmp(res_buf, P_TEXT_DATA, res_len) == 0)
