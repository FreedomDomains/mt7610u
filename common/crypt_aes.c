...
static u8 Const_Zero[16] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static u8 Const_Rb[16] = {
    ...
    INOUT UINT *PlainTextLength)
{
    ...
    PaddingSize = (u8) PlainText[PlainBlockStart -1];
    ...
    OUT UINT *CipherTextLength)
{
	...
	os_alloc_mem(NULL, (UCHAR **)&pResult, sizeof(u8)*PlainTextLength);
    ...
    OUT UINT *PlainTextLength)
{
	...
	os_alloc_mem(NULL, (UCHAR **)&pResult, sizeof(u8)*PlainLength);
