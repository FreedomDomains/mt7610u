	...
	IN bool bNonGFExist)
{
	...
	{
		MacReg = mt76u_reg_read(pAd, TX_PROT_CFG8);
		MacReg &= (~0x18000000);
...
/*============================================================================================*/
	...
	csr1.word = mt76u_reg_read(pAd, SharedKeyModeBase+4*(BssIndex/2));
	...
	IN u8 	 KeyIdx)
{
	...
	csr1.word = mt76u_reg_read(pAd, SharedKeyTableBase+4*(BssIndex/2));
	if ((BssIndex%2) == 0)
	{
		if (KeyIdx == 0)
